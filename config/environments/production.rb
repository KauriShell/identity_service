...
Rails.application.configure do
  ...
  # Solid Queue uses the primary database (see db/migrate/*_create_solid_queue_tables). Run `bin/jobs`
  # (or a dedicated worker tier) to process jobs so spikes enqueue work instead of blocking Puma threads.
